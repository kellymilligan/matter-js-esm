...
Body.update = function (body, deltaTime) {
  deltaTime =
    (typeof deltaTime !== 'undefined' ? deltaTime : 1000 / 60) * body.timeScale
  ...
  body.velocity.x =
    velocityPrevX * frictionAir + (body.force.x / body.mass) * deltaTimeSquared
  body.velocity.y =
    velocityPrevY * frictionAir + (body.force.y / body.mass) * deltaTimeSquared
